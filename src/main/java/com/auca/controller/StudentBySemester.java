 ...
 */
@WebServlet("/StudentBySemester")
public class StudentBySemester extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		 try {
	            // Retrieve the semester_id parameter from the request
	            String semester_id = request.getParameter("semester_id");

	            // Create a RegistrationDao instance and retrieve the list of students for the specified semester
	            RegistrationDao registrationDao = new RegistrationDao();
	            List<RegistrationModel> sregistrationList = registrationDao.viewStudentsBySemester(semester_id);

	            // Set the attribute for the list of students
	            request.setAttribute("sregistrationList", sregistrationList);
