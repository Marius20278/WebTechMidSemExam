...
<select name="academicUnitType" required>
    <% for (com.auca.model.EAcademicUnit academicUnit : com.auca.model.EAcademicUnit.values()) { %>
        <option value="<%= academicUnit %>"><%= academicUnit %></option>
    <% } %>
</select>

   
        
        <input type="text" name="parentId" placeholder="parentID"><br>
