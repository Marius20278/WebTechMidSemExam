...
<%@ page import="com.auca.model.EQualification" %>
...
<select name="qualification" required>
    <% for (com.auca.model.EQualification qualification : com.auca.model.EQualification.values()) { %>
        <option value="<%= qualification %>"><%= qualification %></option>
    <% } %>
</select>

     <input type="text" name="tutor" placeholder="tutor" required><br>
       <input type="text" name="assistant_tutor" placeholder="assistant_tutor" required><br>
